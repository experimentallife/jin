...
{	
	...
	this->setLevelName("Level 1");
	this->setLevelNumber(1);
	
	setLevel(this->window, Resources::getLevel1Map());
	...
	Level(window, hero)
{
	...
	this->setLevelName("Level 2");
	this->setLevelNumber(2);
	
	setLevel(this->window,  Resources::getLevel2Map());
...
Level_03::Level_03(sf::RenderWindow & window, Hero *& hero) :
	Level(window, hero)
{
	startX = 32.0f;
	startY = 620.0f;
	...
	this->setLevelName("Level 3");
	this->setLevelNumber(2);
	
	setLevel(this->window, Resources::getLevel3Map());
